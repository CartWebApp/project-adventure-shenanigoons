                                    ...
                                    scenes: [{
                                        ...
                                        scenes: [{
                                            ...
                                            scenes: [{
                                                ...
                                                options: [`Yep!`, `NAH`],
                                                scenes: [{
                                                    text: `Holding a leek, Miku casts a killing spell upon you, "AVADA KADAVRA", your group is completely obliterated \n\n YOU DIED`, image: `images/prison/destroy/surrender/6.jpg`,
                                                    options: [`Go back`, `Restart from beginning`],
                                                    scenes: [{ path: [`p`, `p`] }, { path: [`P`] }]
                                                }, {
                                                    text: `"You decided to team up with him, you have to take responsiblity for who you choose to associate with!" \n\n"ONE TWO THREE MIKU MIKU BEAM" \n\nYou and your team are vanquished and not a molecule is left \n\n YOU DIED`, image: `images/prison/destroy/surrender/7.jpg`,
                                                    options: [`Go back`, `Restart from beginning`],
                                                    scenes: [{ path: [`p`, `p`] }, { path: [`P`] }]
                                                }]
                                            }, {
                                                text: `"All I wanted to do, is follow you"\n\nYOU HAVE REACHED THE UNDERLING ENDING`, image: `images/prison/destroy/surrender/15.jpg`,
                                                cutscene: [{ text: `Markiplier replies, knowing exactly what to say`, image: `images/prison/destroy/surrender/8.jpg` }, { text: `"Hello everybody, my name is Markiplier"`, image: `images/prison/destroy/surrender/9.jpg` }, { text: `The aura that came out of this statement was the most the world has ever seen, besides Satoru Gojo of course`, image: `images/prison/destroy/surrender/10.jpg` }, { text: `Miku is taken aback, seeing this amount of aura truly impressed her. Because of this, she was moved`, image: `images/prison/destroy/surrender/11.jpg` }, { text: `"Why, what a great offer, I can see why you chose this side of the war, you're the smart ones..."`, image: `images/prison/destroy/surrender/12.jpg` }, { text: `Miku addresses you, "I'm on top of the world, because of you. You have untapped power, and I knew that if I didn't take this chance, I would not be able to make this world mine."`, image: `images/prison/destroy/surrender/13.jpg` }, { text: `You thank Miku for this generous offer`, image: `images/prison/destroy/surrender/14.jpg` }],
                                                options: [`Play again`],
                                                scenes: [{ path: [`P`] }]
                                            }]
                                        }, {
                                            text: `You go to attack Miku in a one on one, and she challenges you to a one versus one in a rhythm game. It all comes down to this, the world depends on you\n\nControl the rhythm game with the DFJK keys`, image: `images/prison/destroy/fight/4.jpg`,
                                            cutscene: [{ text: `PewDiePie unleashes his long range punch, dazing Miku, and Markiplier gets ready for an attack. DanTDM takes this opportunity, when shes dazed, to fly in and swing his diamond sword at Miku, slicing her leek wand in half`, image: `images/prison/destroy/fight/1.jpg` }, { text: `Stampy joins the fray, trying to charm Miku for you to do the final attack, this of course, doesn't work. Hatsune Miku came prepared, nobody can charm Miku the way Teto could...`, image: `images/prison/destroy/fight/2.jpg` }, { text: `Enraged by this, Miku attacks your team, leaving them all injured but you`, image: `images/prison/destroy/fight/3.jpg` }],
                                            options: ['Continue'],
                                            scenes: [{
                                                text: ``,
                                                options: [],
                                                scenes: [{
                                                    text: `Miku doesn't think twice before vaporizing you with her Miku Miku beam.\n\nYOU DIE`, image: `images/prison/destroy/fight/6.jpg`,
                                                    options: [`Retry game`, `Restart from beginning`],
                                                    scenes: [{ path: [`p`] }, { path: [`P`] }]
                                                }, {
                                                    text: `You won. The world can finally rest, the dictatorship by Miku is over. You don't have to worry about the world being hers, and you go back to Good Burger with your new friends\n\nYOU HAVE REACHED THE TEAMWORK ENDING`, image: `images/prison/destroy/fight/5.jpg`,
                                                    options: [`Play again`],
                                                    scenes: [{ path: [`P`] }]
                                                }],
                                                startGame: true
